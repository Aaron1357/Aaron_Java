...
public class ConditionPractice {
	 ...
	 * 중간고사 (20%), 기말고사 (30%), 과제 (30%), 출석 (20%) ​ 이 때, 출석 회수는 총 강의 회수 20회 중에서 출석한
	 * 날만 입력 ​ 총 점이 70점 이상이면서 전체 강의의 70%이상 출석을 했을 경우 Pass, 아니면 Fail을 출력하세요. ​ ​ 중간
	 * 고사 점수 : 80 기말 고사 점수 : 90 과제 점수 : 50 출석 회수 : 15 ===========결과========== 중간 고사
	 * 점수(20) : 16.0 기말 고사 점수(30) : 27.0 과제 점수 (30) : 15.0 출석 점수 (20) : 15.0 총점 :
	 * 73.0 PASS ​ 중간 고사 점수 : 80 기말 고사 점수 : 30 과제 점수 : 60 출석 회수 : 18
	 * ===========결과========== FAIL [점수 미달] (총점 61.0) ​ 중간 고사 점수 : 90 기말 고사 점수 : 100
	 * 과제 점수 : 80 출석 회수 : 13 ===========결과========== FAIL [출석 횟수 부족] (13/20) ​ 중간 고사
	 * 점수 : 100 기말 고사 점수 : 80 과제 점수 : 40 출석 회수 : 10 ===========결과========== FAIL [출석
